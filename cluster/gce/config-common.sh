...
WINDOWS_CNI_STORAGE_PATH="https://storage.googleapis.com/k8s-artifacts-cni/release"
# CNI version for Windows nodes
WINDOWS_CNI_VERSION="v0.8.5"
...
WINDOWS_INFRA_CONTAINER="gcr.io/gke-release/pause-win:1.1.0"
